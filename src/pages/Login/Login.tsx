    ...
    <div className={styles.container}>
        ...
        <div className={styles.login}>
           <div className={styles.logoRedondo}>
                ...
                <p className={styles.Slogan}>Banco de dados dos bens tombados da Cidade de São Paulo</p>
            </div>
            ...
            <form className={styles.form}> 
                ...
                <div>
                    <a href="./sla" className={styles.esqueceuSenha}>Esqueceu a senha?</a>
                    <input className={styles.buttonLogin} type="button" value="Iniciar sessão"/>
                </div>
